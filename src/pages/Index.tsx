        ...
        <section id="reviews" className="container mx-auto px-6 py-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                name: 'Алексей В.',
                text: 'Сегодня, спустя один месяц назад, я пишу этот отзыв о работе Дамира✨✨✨. Хочу отметить для уважаемых участников группы, что являюсь психологом и профессионалом в сфере гипнотерапии 🌀. Чтобы не занимать время многочисленными диферамбами в адрес Дамира, сразу напишу о результатах! 26 октября 2025 года мы провели сессию гипнотерапии, а 1 ноября 2025 года меня резко назначили на руководящую должность, о которой я даже не мечтал 🤗. В кратце скажу, что с детства были проблемы во взаимоотношениях с отцом. На сегодняшний момент эти проблемы в прошлом, тк мы замечательно стали общаться с папой🙏. Хвала Создателю за такие быстрые и лёгкие трансформации, а Дамиру благодарность за профессионализм 🏆.',
                rating: 5
              },
              {
                name: 'Ольга М.',
